package com.epam.jb2.patterns.decorator;

import com.epam.jb2.patterns.decorator.decorators.*;
import com.epam.jb2.patterns.decorator.entity.FigureShape;
import com.epam.jb2.patterns.decorator.entity.implementation.*;
import com.epam.jb2.patterns.decorator.constants.*;

public class Main {
    public static void main(String[] args) {

        System.out.println("Creating Simple Shape Objects...");
        FigureShape rectangle = new Rectangle();
        FigureShape circle = new Circle();
        ...
        FigureShape circle1 = new FillColorDecorator(
                new LineColorDecorator(
                        new LineStyleDecorator(
                                new LineThicknessDecorator(new Circle(), 2.0d),
        ...
        FigureShape circle3 = fc;
        circle3.draw();
        System.out.println();

        System.out.println("Creating Decorated Circle with Green Color, Black Lines ...");
        FigureShape circle2 = new FillColorDecorator(new LineColorDecorator(new Circle(), Color.BLACK), Color.GREEN);
        circle2.draw();
        System.out.println();

        System.out.println("Creating Decorated Rectange with Yellow Color, Red Lines in double dash pattern...");
        FigureShape rectangle1 = new FillColorDecorator(new LineColorDecorator(new Rectangle(), Color.RED), Color.YELLOW);
        rectangle1.draw();
        System.out.println();
